...
import 'package:facebook_interface_aula/models/Usuario.dart';
         ...
         Container(
           ...
           child: Row(
             ...
             children: [
               ...
               label: Text("Ao vivo", style: TextStyle(
                 color: Colors.black
               ),
               ),
             ),
               ...
               TextButton.icon(
                 ...
                 label: Text("Foto", style: TextStyle(
                     color: Colors.black
                 ),
                 ),
               ),
               ...
               TextButton.icon(
                 ...
                 label: Text("Sala", style: TextStyle(
                     color: Colors.black
                 ),
                 ),
               )
