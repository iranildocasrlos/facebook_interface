...
Usuario usuarioAtual = Usuario(
    nome: "Iranildo Carlos",
    urlImagem: "https://localoeste.com.br/ServidorDocumentos/ucloud/direct/view.php?s=HI&/391C1614-A57B-467A-8BC3-3D5632BA6A13.jpeg"
);

/* Lista de usuários online */
List<Usuario> usuariosOnline = [
  Usuario(
      nome: "Rubens Camattari",
...
List<Postagem> postagens = [
  Postagem(
      ...
      tempoAtras: "20m",
      urlImagem: "https://source.unsplash.com/tvva--6D7I8/800x600",
      curtidas: 30,
      comentarios: 3,
      compartilhamentos: 5
  ),
  Postagem(
      usuario: usuariosOnline[1],
      descricao: "Quero compartilhar com você meu espaço...",
      tempoAtras: "40m",
      urlImagem: "https://source.unsplash.com/lBJZPTu8Ysg/800x600",
      curtidas: 30,
      comentarios: 3,
      compartilhamentos: 5
  ),
  ...
  Postagem(
      ...
      tempoAtras: "1h",
      urlImagem: "https://source.unsplash.com/BqgDTtbzYaU/800x600",
      curtidas: 30,
      comentarios: 3,
      compartilhamentos: 5
  ),
